...
const ProductCard = ({product}) => {
    ...
    return (
        <div className="p-2 pb-4 bg-white rounded-sm shadow-md">
            ...
            <Link to={`/products/${_id}`} className='bg-linear-to-tr from-[#632EE3] to-[#9F62F2] bg-clip-text text-transparent border border-[#632EE3] rounded-sm py-1.5 block text-center'>View Details</Link>
        </div>
    );
};
